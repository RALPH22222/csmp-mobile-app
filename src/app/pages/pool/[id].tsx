...
const MOCK_MEMBERS = [
  { id: "m1", name: "Aling Rosa", week: 1, status: "Paid", image: "https://i.pravatar.cc/150?img=47" },
  { id: "m2", name: "Kuya Jun", week: 2, status: "Paid", image: "https://i.pravatar.cc/150?img=11" },
  { id: "m3", name: "Maria", week: 3, status: "Current Week", isYou: true, image: "https://i.pravatar.cc/150?img=5" },
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="px-5 py-3 bg-white border-b border-[#f0f2f2] flex-row items-center">
        ...
        <Text className="flex-1 text-[18px] font-extrabold text-[#003840]" numberOfLines={1}>
          {pool.title}
        </Text>
      </View>
      ...
      <View className="flex-1 bg-[#f7f9f9]">
        ...
        >
          ...
          >
            ...
            <View className="flex-row items-center mb-5">
              <View className="w-14 h-14 rounded-full bg-[#006D77] items-center justify-center mr-3.5">
                <MaterialCommunityIcons name="piggy-bank" size={28} color="#ffffff" />
              </View>
              <View>
                <Text className="text-[12px] text-[#6f797a] font-medium mb-0.5">Total Locked Pool</Text>
            ...
            <View className="flex-row justify-between mb-2">
              <Text className="text-[13px] font-bold text-[#003840]">Week 3 of 5</Text>
            ...
            >
              ...
              <Text className="text-[15px] font-bold text-white ml-2">Pay Week 3 Share</Text>
            </TouchableOpacity>
          </View>
          ...
          >
            ...
            <Text className="text-[15px] font-bold text-[#006D77] ml-2">Join this Pool</Text>
          </TouchableOpacity>

          {/* Member Roster */}
          <Text className="text-[17px] font-extrabold text-[#003840] mb-3.5">Member Roster</Text>
                    ...
                    <View className="flex-row items-center mb-0.5">
                      ...
                      {isCurrent && (
                        <View className="ml-1.5 bg-[#003840] px-1.5 py-0.5 rounded">
                          <Text className="text-[9px] font-extrabold text-white tracking-widest">CURRENT</Text>
                        </View>
                      )}
                    </View>
                    <Text
                      className="text-[12px]"
                      style={{ color: isCurrent ? "#006D77" : "#6f797a", fontWeight: isCurrent ? "600" : "400" }}
                    >
                      {isCurrent ? "Receives payout this Friday" : `Week ${member.week} Payout`}
                    </Text>
                  </View>
                  ...
                  <View>
                    {isPaid ? (
                      <View className="flex-row items-center bg-[#00897b] px-2.5 py-1.5 rounded-full">
                        ...
                        <Text className="text-[12px] font-bold text-white ml-1">Paid</Text>
                      </View>
                    ) : isCurrent ? (
                      <View className="flex-row items-center bg-[#006D77] px-2.5 py-1.5 rounded-full opacity-90">
                        <Ionicons name="hourglass-outline" size={14} color="#e0f7fa" />
                        <Text className="text-[12px] font-bold text-[#e0f7fa] ml-1">Pending</Text>
                      </View>
                    ) : (
                      <View className="flex-row items-center bg-[#f0f2f2] px-2.5 py-1.5 rounded-full border border-[#dce0e0]">
                        <Ionicons name="calendar-outline" size={14} color="#6f797a" />
                        <Text className="text-[12px] font-bold text-[#6f797a] ml-1">Upcoming</Text>
                      </View>
                    )}
                  </View>
                </View>
